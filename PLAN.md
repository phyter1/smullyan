...
combinatory-logic "birds" of Raymond Smullyan's _To Mock a Mockingbird_, plus a small
...
### 3.2 The hard forest — birds that are _not_ simply typeable
...
limitation. TypeScript's _equirecursive-ish_ interfaces do give us a way through:
...
A dedicated suite asserting that _incorrect_ usage **fails to compile**. This is the only
...
function ran; a law test tells you it was _correct_.
