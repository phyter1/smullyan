...
export default defineConfig({
  ...
  entry: {
    ...
    'es-birds': 'src/lang/es/birds.ts',
    'es-pipe': 'src/lang/es/pipe.ts',
    'es-option': 'src/lang/es/option.ts',
    'es-result': 'src/lang/es/result.ts',
    'es-task': 'src/lang/es/task.ts',
    'es-reader': 'src/lang/es/reader.ts',
    'es-agent': 'src/lang/es/agent.ts',
